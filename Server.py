...
def logo():
    banner = f"""
                                      ...
                                      ╚══════╦════════════════════════╦══════╝
                               ╔═════════════╩════════════════════════╩═════════════╗
                               ║         {color.WHITE}    ~ Welcome to Nesuko's Net{color.RESET}{color.BLUE}{Style.DIM}              ║
                               ║      {color.WHITE}~ Developed by @7evenSecc & daqesha#1337{color.RESET}{color.BLUE}{Style.DIM}      ║
                               ╚════════════════════════════════════════════════════╝
                       ╔═════════════════════════════════════════════════════════════════════╗ 
                       ║  {color.WHITE}~ Nesuko's Offical Discord server: {color.RESET}{color.GREEN}https://discord.gg/5cZFHpFx {color.RESET}~{color.LIGHTMAGENTA_EX}{Style.DIM}   ║
                       ║            {color.WHITE}"   It's not illgal until you get caught   "{color.RESET}{color.LIGHTMAGENTA_EX}             ║
                       ╚═════════════════════════════════════════════════════════════════════╝
